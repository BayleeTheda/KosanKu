...
public class ReportTagihanKosFragment extends Fragment {

    public ReportTagihanKosFragment() {
        // Required empty public constructor
    }

    // Factory method untuk membuat instance baru
    public static ReportTagihanKosFragment newInstance() {
        return new ReportTagihanKosFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        back_btn.setOnClickListener(v -> {
            ...
            requireActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.flFragment, new TagihanKosFragment())
